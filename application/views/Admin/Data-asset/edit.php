           ...
           <div class="card p-2">
             ...
             <input type="hidden" name="id" value="<?= $aset['id'] ?>">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="category" name="category" placeholder="Masukkan Kategori Aset" value="<?= $aset['category']; ?>">
                <small class="form-text text-danger"><?= form_error('category') ?></small>
              </div>
              
              <div class="form-group">
                <label for="department">Department</label>
                <input type="text" class="form-control" id="department" name="department" placeholder="Masukkan Nama Department" value="<?= $aset['department']; ?>">
                <small class="form-text text-danger"><?= form_error('department') ?></small>
              </div>
              <div class="form-group">
                <label for="location">Lokasi Aset</label>
                <input type="text" class="form-control" id="location" name="location" placeholder="Masukkan Nama Lokasi" value="<?= $aset['location']; ?>">
