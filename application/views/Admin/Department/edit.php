        ...
        <div class="content">
          <div class="container-fluid">
           ...
           <div class="card p-2">
              ...
              <h5 class="text-center"> <strong>Edit Department</strong></h5> 
             </div>
             <?= form_open_multipart('department/edit'); ?>
             <input type="hidden" name="id" value="<?= $department['id'] ?>">
              <div class="form-group">
                <label for="department_code">Kode Kategori</label>
                <input type="number" class="form-control" id="department_code" name="department_code" placeholder="Masukkan Kode Department" value="<?= $department['department_code']; ?>">
                <small class="form-text text-danger"><?= form_error('department_code') ?></small>
              </div>
              <div class="form-group">
                <label for="department_name">Deskripsi</label>
                <input type="text" class="form-control" id="department_name" name="department_name" placeholder="Masukkan Nama Department" value="<?= $department['department_name']; ?>">
